...
ordering (notification_deliveries -> notifications -> job_matches -> applications
-> job_source_records -> canonical_jobs -> orphaned raw_jobs) — repositories stay
scoped to their own tables, this coordinates them. See app/workers/tasks/retention.py.
"""
